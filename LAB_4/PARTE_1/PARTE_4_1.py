...
from MODULO_PM_LAB4 import MODULO_PM_LAB4  # grc-generated hier_block
...
class PARTE_4_1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "PARTE_4_1")
        ...
        self.MODULO_PM_LAB4_0 = MODULO_PM_LAB4(
            Ac=Ac,
            Kp=Kp,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.MODULO_PM_LAB4_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.MODULO_PM_LAB4_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.MODULO_PM_LAB4_0, 0), (self.uhd_usrp_sink_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.MODULO_PM_LAB4_0, 0))
    ...
    def set_Kp(self, Kp):
        self.Kp = Kp
        self.MODULO_PM_LAB4_0.set_Kp(self.Kp)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.MODULO_PM_LAB4_0.set_Ac(self.Ac)




def main(top_block_cls=PARTE_4_1, options=None):
