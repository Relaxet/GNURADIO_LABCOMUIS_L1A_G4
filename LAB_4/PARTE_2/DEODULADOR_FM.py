...
# Title: demodulador de emisoras comerciales
...
class DEODULADOR_FM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "demodulador de emisoras comerciales", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demodulador de emisoras comerciales")
        ...
        self.settings = Qt.QSettings("GNU Radio", "DEODULADOR_FM")
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.qtgui_freq_sink_x_0_0.set_frequency_range(0, int(self.samp_rate/self.D))
...
def main(top_block_cls=DEODULADOR_FM, options=None):
