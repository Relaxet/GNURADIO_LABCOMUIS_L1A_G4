...
class punto1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "Miguel Garcia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Miguel Garcia")
        ...
        self._GTX_win = RangeWidget(self._GTX_range, self.set_GTX, "Ganancia de transmisor (GTX)", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._GTX_win)
        self._Am_range = Range(0, 4, 100e-3, 3, 200)
        ...
        self.CalculoPotenciaComunicaciones_1 = CalculoPotenciaComunicaciones(
            I_vect=1024,
        )

        self.top_layout.addWidget(self.CalculoPotenciaComunicaciones_1)
        ...
        self.connect((self.blocks_complex_to_real_0, 0), (self.CalculoPotenciaComunicaciones_1, 0))
    ...
    def set_Ka(self, Ka):
        self.Ka = Ka
        self.EnvolventeCompleja_DSB_0.set_Ka(self.Ka)
