...
# Title: modulacion en banda lateral unica
...
from Calculo_potencia import Calculo_potencia  # grc-generated hier_block
from PyQt5 import Qt
from gnuradio import qtgui
from gnuradio.filter import firdes
import sip
from ec_SSB import ec_SSB  # grc-generated hier_block
...
class AM_bandalateral(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "modulacion en banda lateral unica", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("modulacion en banda lateral unica")
        ...
        self.settings = Qt.QSettings("GNU Radio", "AM_bandalateral")
        ...
        self._fm_range = Range(200, 21000, 100, 1000, 200)
        ...
        self._Am_range = Range(0, 4, .1, 1, 200)
        ...
        self._Ac_range = Range(0, 1, .1, .125, 200)
        ...
        self.ec_SSB_0 = ec_SSB(
            Ac=Ac,
            B=B,
            K=k,
        )
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, fm, Am, 0, 0)
        self.Calculo_potencia_0 = Calculo_potencia(
            l_vect=1024,
        )

        self.top_layout.addWidget(self.Calculo_potencia_0)


        ##################################################
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.Calculo_potencia_0, 0))
        self.connect((self.analog_sig_source_x_0, 0), (self.ec_SSB_0, 0))
        self.connect((self.ec_SSB_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.ec_SSB_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.ec_SSB_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.ec_SSB_0.set_Ac(self.Ac)




def main(top_block_cls=AM_bandalateral, options=None):
