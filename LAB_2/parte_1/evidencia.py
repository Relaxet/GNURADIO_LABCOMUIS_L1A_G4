...
class evidencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "evidencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("evidencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "evidencia")
...
def main(top_block_cls=evidencia, options=None):
