...
class ConfiguracionTrasmisor(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "trasmisor", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("trasmisor")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ConfiguracionTrasmisor")
...
def main(top_block_cls=ConfiguracionTrasmisor, options=None):
