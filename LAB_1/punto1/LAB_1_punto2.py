...
# Title: Lab1_punto_2_4muestreo
# Author: Miguel_Garcia_L1A_G4
...
class LAB_1_punto2(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Lab1_punto_2_4muestreo", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Lab1_punto_2_4muestreo")
        ...
        self.settings = Qt.QSettings("GNU Radio", "LAB_1_punto2")
...
def main(top_block_cls=LAB_1_punto2, options=None):
