...
class ModuladorPWM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._Fm_win = RangeWidget(self._Fm_range, self.set_Fm, "fracuencia del mesaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._DC_range = Range(-10, 10, .1, 0, 200)
        self._DC_win = RangeWidget(self._DC_range, self.set_DC, "nivel de continua de sierra", "counter_slider", float, QtCore.Qt.Horizontal)
        self.top_layout.addWidget(self._DC_win)
        self._A_range = Range(-10, 10, .1, 2, 200)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_CONST_WAVE, Fm, 3, 0, 0)
