...
# Title: demodulacion_demuplexionPAM
...
class demulplexionPAM(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "demodulacion_demuplexionPAM", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("demodulacion_demuplexionPAM")
        ...
        self.settings = Qt.QSettings("GNU Radio", "demulplexionPAM")
        ...
        self.filter_fft_low_pass_filter_0_0_2 = filter.fft_filter_fff(1, firdes.low_pass(8, samp_rate, fs/2, 50, window.WIN_HAMMING, 6.76), 1)
        self.filter_fft_low_pass_filter_0_0_1 = filter.fft_filter_fff(1, firdes.low_pass(8, samp_rate, fs/2, 100, window.WIN_HAMMING, 6.76), 1)
        self.filter_fft_low_pass_filter_0_0_0 = filter.fft_filter_fff(1, firdes.low_pass(8, samp_rate, fs/2, 50, window.WIN_HAMMING, 6.76), 1)
        self.filter_fft_low_pass_filter_0_0 = filter.fft_filter_fff(1, firdes.low_pass(8, samp_rate, fs/2, 100, window.WIN_HAMMING, 6.76), 1)
        self.blocks_delay_0_2_0_0 = blocks.delay(gr.sizeof_float*1, D3)
        self.blocks_delay_0_2_0 = blocks.delay(gr.sizeof_float*1, D2)
        self.blocks_delay_0_2 = blocks.delay(gr.sizeof_float*1, D1)
        ...
        self.ModuladorPAM_0_1_0_0_1 = ModuladorPAM(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModuladorPAM_0_1_0_0_0 = ModuladorPAM(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        self.ModuladorPAM_0_1_0_0 = ModuladorPAM(
            d=D,
            fs=fs,
            samp_rate=samp_rate,
        )
        ...
        self.connect((self.ModuladorPAM_0_1_0, 0), (self.filter_fft_low_pass_filter_0_0_0, 0))
        self.connect((self.ModuladorPAM_0_1_0_0, 0), (self.filter_fft_low_pass_filter_0_0, 0))
        self.connect((self.ModuladorPAM_0_1_0_0_0, 0), (self.filter_fft_low_pass_filter_0_0_1, 0))
        self.connect((self.ModuladorPAM_0_1_0_0_1, 0), (self.filter_fft_low_pass_filter_0_0_2, 0))
        ...
        self.connect((self.blocks_add_xx_0, 0), (self.ModuladorPAM_0_1_0_0_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_delay_0_2, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_delay_0_2_0, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_delay_0_2_0_0, 0))
        ...
        self.connect((self.blocks_delay_0_2, 0), (self.ModuladorPAM_0_1_0, 0))
        self.connect((self.blocks_delay_0_2_0, 0), (self.ModuladorPAM_0_1_0_0, 0))
        self.connect((self.blocks_delay_0_2_0_0, 0), (self.ModuladorPAM_0_1_0_0_0, 0))
        self.connect((self.filter_fft_low_pass_filter_0_0, 0), (self.qtgui_time_sink_x_0_0, 2))
        self.connect((self.filter_fft_low_pass_filter_0_0_0, 0), (self.qtgui_time_sink_x_0_0, 1))
        self.connect((self.filter_fft_low_pass_filter_0_0_1, 0), (self.qtgui_time_sink_x_0_0, 3))
        self.connect((self.filter_fft_low_pass_filter_0_0_2, 0), (self.qtgui_time_sink_x_0_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.ModuladorPAM_0_1_0_0.set_samp_rate(self.samp_rate)
        self.ModuladorPAM_0_1_0_0_0.set_samp_rate(self.samp_rate)
        self.ModuladorPAM_0_1_0_0_1.set_samp_rate(self.samp_rate)
        ...
        self.filter_fft_low_pass_filter_0_0.set_taps(firdes.low_pass(8, self.samp_rate, self.fs/2, 100, window.WIN_HAMMING, 6.76))
        self.filter_fft_low_pass_filter_0_0_0.set_taps(firdes.low_pass(8, self.samp_rate, self.fs/2, 50, window.WIN_HAMMING, 6.76))
        self.filter_fft_low_pass_filter_0_0_1.set_taps(firdes.low_pass(8, self.samp_rate, self.fs/2, 100, window.WIN_HAMMING, 6.76))
        self.filter_fft_low_pass_filter_0_0_2.set_taps(firdes.low_pass(8, self.samp_rate, self.fs/2, 50, window.WIN_HAMMING, 6.76))
    ...
    def set_fs(self, fs):
        ...
        self.ModuladorPAM_0_1_0_0.set_fs(self.fs)
        self.ModuladorPAM_0_1_0_0_0.set_fs(self.fs)
        self.ModuladorPAM_0_1_0_0_1.set_fs(self.fs)
    ...
    def set_D3(self, D3):
        ...
        self.blocks_delay_0_2_0_0.set_dly(self.D3)
    ...
    def set_D2(self, D2):
        ...
        self.blocks_delay_0_2_0.set_dly(self.D2)
    ...
    def set_D1(self, D1):
        ...
        self.blocks_delay_0_2.set_dly(self.D1)
    ...
    def set_D(self, D):
        ...
        self.ModuladorPAM_0_1_0.set_d(self.D)
        self.ModuladorPAM_0_1_0_0.set_d(self.D)
        self.ModuladorPAM_0_1_0_0_0.set_d(self.D)
        self.ModuladorPAM_0_1_0_0_1.set_d(self.D)
...
def main(top_block_cls=demulplexionPAM, options=None):
