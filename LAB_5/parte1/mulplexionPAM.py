...
class mulplexionPAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "mulplexionPAM")
        ...
        self.filter_fft_low_pass_filter_0 = filter.fft_filter_fff(1, firdes.low_pass(4, samp_rate, fs/2, 100, window.WIN_HAMMING, 6.76), 1)
        ...
        self.connect((self.ModuladorPAM_0_1_0, 0), (self.filter_fft_low_pass_filter_0, 0))
        ...
        self.connect((self.filter_fft_low_pass_filter_0, 0), (self.qtgui_time_sink_x_0, 2))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.filter_fft_low_pass_filter_0.set_taps(firdes.low_pass(4, self.samp_rate, self.fs/2, 100, window.WIN_HAMMING, 6.76))
...
def main(top_block_cls=mulplexionPAM, options=None):
